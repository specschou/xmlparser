...
//				String cookie = itemProps.getProperty("cookie");
				...
				String npCokTime = itemProps.getProperty("npCokTime");
				String yearMatch = itemProps.getProperty("yearMatch");
				String trainMatch = itemProps.getProperty("trainMatch");
				...
				if (npCokTime != null) {
					timeParams.put("npCokTime", npCokTime);
				}
				if (yearMatch != null) {
					timeParams.put("yearMatch", yearMatch);
				}
				if (trainMatch != null) {
					timeParams.put("trainMatch", trainMatch);
				}
